...
class Customer(TransactionBase):
	...
	if TYPE_CHECKING:
		...
		customer_type: DF.Literal["Company", "Individual", "Partnership", "Eu Customer"]
		...
		is_dealer_verified: DF.Check
		is_frozen: DF.Check
		is_internal_customer: DF.Check
		is_phone_number_verified: DF.Check
